...
```{r echo=FALSE, fig.align="center", fig.align="center", message=FALSE, warning=FALSE, paged.print=FALSE, out.width="50%"}
...
```{r, echo=FALSE, fig.align="center", error=FALSE, message=FALSE, warning=FALSE, comment = NA, out.width="50%"}
...
dunnTest(relative_oxidation ~ neuron, 
             data = data_for_plotting_2, method="bonferroni")$res %>% 
  knitr::kable(align = "r") 
```
...
```{r 3, echo=FALSE, fig.align="center", error=FALSE, message=FALSE, warning=FALSE, comment = NA, out.width="50%"}
...
dunnTest(axon_area_per_neuron ~ neuron, 
             data = data, method="bonferroni")$res %>% 
  knitr::kable(align = "r") 
```
...
```{r echo=FALSE, fig.align="center", error=FALSE, message=FALSE, warning=FALSE, comment = NA, out.width="50%"}
dunnTest(percentage_syt1_positive ~ neuron, data = data_percentage_syt1_positive, method="bonferroni")$res %>% 
  knitr::kable(align = "r") 
```
...
```{r echo=FALSE, fig.align="center", error=FALSE, message=FALSE, warning=FALSE, comment = NA, out.width="50%"}
dunnTest(mean_nearest_varicsotiey ~ neuron, data = mean_varicosity_nn_length, method="bonferroni")$res %>% 
  knitr::kable(align = "r")   
```
...
```{r echo=FALSE, fig.align="center", error=FALSE, message=FALSE, warning=FALSE, comment = NA, out.width="50%"}
dunnTest(mean_axon_per_var_px ~ neuron, data = mean_varicosity_lengthpervar_length, method="bonferroni")$res %>% 
  knitr::kable(align = "r")  
```
